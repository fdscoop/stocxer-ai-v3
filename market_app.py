...
def register_routes(app: Flask, market_analyzer: MarketAnalyzer, 
                   options_analyzer: IndexOptionsAnalyzer,
                   strategy_generator: OptionsStrategyGenerator) -> None:
...
def create_app(config: Optional[Dict[str, Any]] = None) -> Flask:
    ...
    try:
        ...
        register_routes(app, market_analyzer, options_analyzer, strategy_generator)
